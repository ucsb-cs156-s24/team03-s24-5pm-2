...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_ucsbdiningcommonsmenuitem() throws Exception {
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("Appetizer");
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-station").fill("beverages");
        page.getByTestId("UCSBDiningCommonsMenuItemForm-submit").click();

        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemTable-cell-row-0-col-station")).hasText("beverages");
