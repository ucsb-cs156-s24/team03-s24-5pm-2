...
public class HelpRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_helprequest() throws Exception {
        ...
        page.getByTestId("HelpRequestForm-requesterEmail").fill("random@ucsb.edu");
        page.getByTestId("HelpRequestForm-teamId").fill("6pm-6");
        page.getByTestId("HelpRequestForm-submit").click();

        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-requesterEmail")).hasText("random@ucsb.edu");
        assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-teamId")).hasText("6pm-6");
