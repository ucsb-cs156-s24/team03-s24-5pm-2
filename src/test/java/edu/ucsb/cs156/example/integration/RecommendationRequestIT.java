...
public class RecommendationRequestIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                RecommendationRequest recommendationRequest0 = RecommendationRequest.builder()
                ...
                recommendationRequestRepository.save(recommendationRequest0);
                ...
                // assert
                String expectedJson = mapper.writeValueAsString(recommendationRequest0);
                String responseString = response.getResponse().getContentAsString();
                assertEquals(expectedJson, responseString);
        }
