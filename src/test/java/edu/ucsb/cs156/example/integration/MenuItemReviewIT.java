...
public class MenuItemReviewIT {
    ...
    public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
        // arrange
        LocalDateTime ldt = LocalDateTime.parse("2024-05-05T00:00:00");
        ...
        MvcResult response = mockMvc.perform(
                post("/api/menuitemreviews/post")
                        .with(csrf())
                        .param("itemId", "3")
                        .param("reviewerEmail", "fake@gmail.com")
                        .param("stars", "5")
                        .param("dateReviewed", "2024-05-05T00:00:00")
                        .param("comments", "good"))
        ...
        MenuItemReview returnedReview = mapper.readValue(responseString, MenuItemReview.class);

        // Manually setting the ID since it's autogenerated by the database
        review.setId(returnedReview.getId());
